      Real Function Voigt(X,Y)

c-------------------------------------------------------------------------
c----------DESCRIPTION FUNCTION VOIGT-------------------------------------
C     Calcule la fonction de Voigt a partir de l'algorithme decrit
C     par Humlicek JQSRT, 27, 437 (1982).
C     Calule la fonction complexe W(Z)=Exp(-Z*Z)*Erfc(-Z*Z)
C     dans le plan complexe superieur (cad pour y>=0., z=x+iy)
C     La partie reelle est la fonction de Voigt
C     L'erreur relative maximale sur les parties imaginaire et reelle
c     est <1e-4
c-------------------------------------------------------------------------
c-------------------------------------------------------------------------
      Complex t,u,voigt1
