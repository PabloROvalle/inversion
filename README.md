...
![\\Large U=\alpha_1SK_1^T(\alpha_1K_1SK_1^T+\alpha_2K_2SK_2^T+E^2)^{-1}](https://latex.codecogs.com/svg.latex?\Large&space;U=\alpha_1SK_1^T(\alpha_1K_1SK_1^T+\alpha_2K_2SK_2^T+E^2)^{-1})
